...
// NOTE: Bulk PUT /api/tagger/session/edits was removed.
// Use individual PUT /api/tagger/session/edits/:track_id for each track.

/// DELETE /api/tagger/session/edits
///
...
/// PUT /api/tagger/session/edits/:track_id
///
...
/// DELETE /api/tagger/session/edits/:track_id
///
...
/// POST /api/tagger/session/tracks
///
...
/// DELETE /api/tagger/session/tracks/:track_id
///
...
/// POST /api/tagger/session/tracks/remove
///
...
/// PUT /api/tagger/session/edits/:track_id/cover
///
...
/// DELETE /api/tagger/session/edits/:track_id/cover
///
...
/// GET /api/tagger/session/edits/:track_id/cover
///
...
/// PUT /api/tagger/session/edits/:track_id/replacement-audio
///
...
/// DELETE /api/tagger/session/edits/:track_id/replacement-audio
///
...
/// GET /api/tagger/session/edits/:track_id/replacement-audio/stream
///
...
/// POST /api/tagger/session/save-stream
///
