...
use crate::api::auth::FerrotuneAuthenticatedUser as AuthenticatedUser;
...
/// GET /api/music-folders/{id} - Get a single music folder with stats
...
/// POST /api/music-folders - Create a new music folder
...
/// PATCH /api/music-folders/{id} - Update a music folder
...
/// DELETE /api/music-folders/{id} - Delete a music folder
...
/// GET /api/music-folders/{id}/stats - Get detailed stats for a folder
