...
/// GET /api/playlists/{id}/shares - Get all shares for a playlist (owner only).
...
/// PUT /api/playlists/{id}/shares - Set all shares for a playlist (owner only).
...
pub struct SongPlaylistsQuery {
    ...
    #[serde(
        rename = "songId",
        deserialize_with = "crate::api::query::string_or_seq"
    )]
    pub song_ids: Vec<String>,
}
...
/// GET /api/playlists/recently-played - Get recently played playlists
