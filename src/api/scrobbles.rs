...
/// POST /api/scrobbles - Scrobble a song (record playback)
...
///
/// GET /api/scrobbles/check-duplicate?description=...
///
...
///
/// POST /api/scrobbles/import-with-timestamps
///
