...
//!
//! This module provides list endpoints migrated from the native API API,
...
/// GET /api/albums - Get lists of albums
...
/// GET /api/songs/by-genre - Get songs in a specific genre
...
/// GET /api/songs/most-played-recently - Get recently frequent songs
...
/// GET /api/songs/forgotten-favorites - Get songs the user used to play a lot but hasn't listened to recently
