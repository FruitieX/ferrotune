...
/// GET /api/history/entries - list raw scrobbles and listening sessions.
...
/// POST /api/history/delete - delete specific raw history entries.
...
/// POST /api/history/delete-matching - delete all entries matching a filter.
