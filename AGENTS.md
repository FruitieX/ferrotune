...
| `android/feature/downloads/OfflineQueue.kt` | Builds `GetQueueResponse` from Room metadata and implements `OfflineQueueSource` (container order, start-song index, all-downloads fallback) | `materializeOfflineQueue()`, `RoomOfflineQueueSource` |
