...
export type PlayHistoryEntry = { playedAt: string, id: string, parent: string | null, title: string, album: string | null, albumId: string | null, artist: string, artistId: string, track: number | null, discNumber: number | null, year: number | null, genre: string | null, coverArt: string | null, 
/**
